...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-a7eib5m.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-a7eib5m.containers.anotherwebservice.com/
...
```
git clone git@github.com:xennon-sudo/container-a7eib5m.git
cd container-a7eib5m
```
...
```
docker attach container-a7eib5m
```
